 ...
 * For those who want to hold a USD-pegged stablecoin, for whatever reason, it will be better to diversify your risk across a several different stablecoins in one basket, represented by a single liquid coin, one which can always be reedemed for the current market value of the collateral you deposited, and especially one with a provable, auditable promise that:
 * <b>WE WILL BAIL YOU OUT if one of your collateralized stablecoins breaks its peg for good and fails. As we grow in adoption, the smart contract logic intends to continually build up a bailout fund with a total USD value greater than the total USD value of any single coin held in our collateral. More details about this below.</b>
