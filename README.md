 ...
 * While the Roman Empire used gold coins as their preffered form of sound money, we are basically mocking their better, despite ancient, currency (the golden guilder) by printing their own words in their own tongue on our own "dirty fiat."
 * 1 UNUM is hard-coded to always be equal to $1.00 United States Dollar in the contract. If you mint 1.0115 UNUM with your 1.0115 USDT at USD value of also $1.0115, but later Tether drops to a value of 0.99 USD (tough luck), you would still need 1.0115 UNUM to withdraw your 0.99 USD value of Tether.
 * UNUM is unconcerned about its price on other markets. It only cares about its immutable value declared in the Solidity contract. As a lawyer might say, "if you don't like the contract, don't sign [a tx with] it!"
